...
public class TelaProjetos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jFormattedTextField2.setText("12/11/2018");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        int i = (JOptionPane.showConfirmDialog(rootPane, "Você realmente deseja excluir Projeto X ?"));
        
        if(i == 0){
            JOptionPane.showMessageDialog(null, "Projeto X excluído com sucesso.");
            this.dispose();
            new TelaPrincipal().setVisible(true);
        }else{
